...
17~18장의 승인 상태별 진행 범위는 [Android 공개 로드맵 상단 표](release-roadmap.md)를 단일 기준으로 사용합니다. 책의 Android 안내에서는 첫 방문에 로드맵 1~6절을 마친 뒤 17.7절로 돌아가고, 18장에서는 현재 상태에 맞는 로드맵 8절 또는 9절을 진행한 뒤 18.3절로 합류하는지만 확인합니다.
