...
| 18장 | 공개 로드맵 8절 — 프로덕션 트랙 출시와 정식 링크 확인. 아직 승인 전이라면 비공개 테스트 링크로 첫 사용자 확인 | 책 18.4절 |
...
책을 하루에 이어 읽더라도 Google Play 정식 공개는 같은 날 끝나지 않을 수 있습니다. 15~16장에서는 내부 테스트 설치를 목표로 하고, 17장에서 14일 테스트를 시작한 뒤 승인 전에는 비공개 테스트 링크로 18.4절을 진행합니다.
