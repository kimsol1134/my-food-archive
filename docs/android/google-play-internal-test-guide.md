...
| 책 16장 | 9절 설치 확인, 앱을 고친 뒤 9.1절 | 책 16.5절로 돌아가기 |
...
Google Play는 개인 개발자 계정의 경우 정식 공개 전에 비공개 테스트 12명/14일 요구사항이 있습니다. 그 준비는 16장에서 앱을 다듬은 뒤, 이 자료의 12절에서 시작합니다. 오늘은 내부 테스트로 앱을 내 폰에 설치해 보는 것까지입니다.
...
> 17~18장 독자는 실제 작업 순서로 다시 정리한 [`release-roadmap.md`](release-roadmap.md)를 우선 사용하세요. 아래 12~13절은 테스터 모집 문구와 세부 설명이 더 필요할 때 찾아보는 참고 자료입니다.
