...
created: 2026-05-28
updated: 2026-07-10
source_chapter: "15장 AI와 함께 TestFlight에 올리다"
---

# 15장 대응 온라인 자료: Android 앱을 Google Play 내부 테스트에 올리기
...
| 14장까지 완성한 Android 프로젝트 | [`TRD_android.md`](../TRD_android.md), [`Implement_plan_android.md`](../Implement_plan_android.md) 기준으로 만든 앱입니다. |
...
업데이트를 설치한 뒤에는 16장의 기준 그대로 실제 폰에서 바뀐 부분을 확인합니다. 새 아이콘, 버튼 위치, 안내 문구처럼 이번에 고친 지점을 하나씩 열어 봅니다.
