...
이 자료는 Android 앱 개발과 Google Play 배포가 처음인 독자를 위한 온라인 보충 자료입니다. 처음 보는 용어가 나와도 앞에서부터 순서대로 진행하면 됩니다.

첫 목표는 **내부 테스트**입니다. 아직 공개하지 않은 앱을 내 Android 기기와 지정한 테스터에게 먼저 설치해 보는 통로입니다.
...
처음 개발하는 독자가 따라가기 쉽도록, 사람이 해야 하는 일과 클로드 코드가 할 수 있는 일을 나눕니다.
...
방침 페이지 하나에 문의 이메일 안내까지 함께 넣어 두면, 지원 주소가 필요한 항목에도 같은 주소를 쓸 수 있습니다. 작성이 끝나면 책 17.3절의 점검 항목과 함께 확인합니다.
