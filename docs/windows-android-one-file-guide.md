...
- 책 16.4절에서 앱을 수정한 뒤 9.1절만 다시 엽니다.
...
- 책 17장 첫 방문: 로드맵 1~6절에서 점검과 비공개 테스트 시작
- 14일 조건 충족 후: 로드맵 7절에서 프로덕션 접근 신청
- 승인 대기 중 책 18장: 로드맵 9절에서 기존 비공개 테스터용 링크 확인
- 프로덕션 접근 승인 완료, 출시 미제출: 로드맵 8~9절에서 프로덕션 출시 제출과 링크 확인
- 프로덕션 출시 제출 후 앱 심사 중: 로드맵 9절의 승인·심사 대기 경로만 확인
- 앱 심사 승인·정식 공개 완료: 로드맵 9절의 정식 공개 경로만 확인
